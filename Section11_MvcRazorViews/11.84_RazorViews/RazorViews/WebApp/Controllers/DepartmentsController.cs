...
namespace WebApp.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            //var list = new List<AspNetCoreGeneratedDocument.Views_Departments_Index>()
            //{
            //    new AspNetCoreGeneratedDocument.Views_Departments_Index()
            //    {

            //    },
            //    new AspNetCoreGeneratedDocument.Views_Departments_Index()
            //};
            //var third = new AspNetCoreGeneratedDocument.Views_Departments_Index();
            //list.Add(third);
        ...
        public IActionResult Details(int id)
        {
            ...
            if (department == null)
            {
                ...
                return Content("<h3 style='color: red'>Department not found.</h3>", "text/html",System.Text.Encoding.UTF8);
            }
