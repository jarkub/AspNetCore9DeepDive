...
app.Run(async (HttpContext context) =>
{
    ...
    else if (context.Request.Method == "DELETE")
    {
        ...
        else if (context.Request.Path.StartsWithSegments("/fakeauth"))
        {
            if (context.Request.Headers["Authorization"] == "Bearer your_access_token")
            {
                await context.Response.WriteAsync("You are authorized!");
            }
            else
            {
